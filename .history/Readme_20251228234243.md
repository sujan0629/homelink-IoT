...
An open-source IoT-based smart home automation system that enables remote monitoring and control of household utilities through a mobile application. Built with ESP32, Express.js, Socket.IO, and React Native for real-time, cross-platform home automation.
